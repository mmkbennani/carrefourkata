...
import com.carrefour.infrastructure.h2.repoimpl.DeliveryServiceImpl;
...
class DeliveryServiceImplTest {
    ...
    void setUp() {
        ...
        delivery = Delivery.builder()
            .id(1L)
            .customerId(customerId.longValue())
            .deliveryOption(com.carrefour.infrastructure.h2.entity.DeliveryOptionEnum.DRIVE)
            .build();
    }
    ...
    void saveDelivery_ShouldHandleOtherDeliveryOptions() {
        ...
        com.carrefour.infrastructure.h2.entity.DeliveryOptionEnum otherEntityOption =
            com.carrefour.infrastructure.h2.entity.DeliveryOptionEnum.DELIVERY;
